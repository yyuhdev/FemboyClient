...
public class EntityESPModule extends Button {
    public static boolean enabled = false;
    private static final String CONFIG_PATH = "modules.entity_esp";

    public EntityESPModule() {
        super("EntityESP", enabled);
    ...
    public void onUpdate(RenderEntityEvent event) {
        ...
        if (entity instanceof MobEntity) {
            ...
            ESPRenderer.Color4b color = new ESPRenderer.Color4b(0, 0, 255, 255);
