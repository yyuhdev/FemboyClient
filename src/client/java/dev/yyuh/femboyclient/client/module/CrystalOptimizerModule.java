            ...
            if (isLookingAt(Blocks.OBSIDIAN, generalLookPos().getBlockPos())
                ...
                if (hitResult instanceof BlockHitResult) {
                    ...
                    if (canPlaceCrystalServer(block))
                        event.getContext().getStack().decrement(-1);
                }
            }
        }
    }
