...
public class QuickAirPlaceModule extends Button {
    private static int state;
    public static boolean enabled = false;
    public static MinecraftClient mc = MinecraftClient.getInstance();
    private static final String CONFIG_PATH = "modules.retard_anchor";

    public QuickAirPlaceModule() {
        super("Quick D-Anchor", enabled);
